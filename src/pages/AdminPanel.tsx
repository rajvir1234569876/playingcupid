...
export default function AdminPanel() {
  ...
  const createEvent = async () => {
    ...
    try {
      ...
      setNewEvent({ name: "", ageRange: "2", revealTime: "", adminPassword: "" });
      fetchEvents();
    } catch (error) {
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          <div>
            ...
            <p className="text-muted-foreground">Manage your OneMatch events</p>
          </div>
        </motion.div>
                            ...
                            <CardDescription className="flex items-center gap-2 mt-1">
                              <span className={`
                                ...
                                ${event.status === "waiting" ? "bg-yellow-500/20 text-yellow-400" : 
                                  event.status === "matching" ? "bg-blue-500/20 text-blue-400" :
                      ...
                      <CardContent>
                        <div className="flex items-center justify-between">
                          ...
                          {event.status === "waiting" && (
                            <Button
                              onClick={() => handleTriggerReveal(event)}
                              disabled={isTriggering === event.id}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setNewEvent((prev) => ({ ...prev, ageRange: e.target.value }))}
                      className="bg-background/50 border-border"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <Input
                    id="adminPassword"
                    type="password"
                    placeholder="Required to trigger reveal"
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                className="bg-background/50 border-border mt-2"
                onKeyDown={(e) => e.key === "Enter" && authenticateAndTrigger()}
              />
            </div>
            <Button
              onClick={authenticateAndTrigger}
              className="w-full bg-primary hover:bg-primary/90"
            >
              Confirm & Trigger
            </Button>
