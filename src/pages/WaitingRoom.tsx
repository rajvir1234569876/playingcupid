    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <motion.p
          ...
          className="text-lg text-champagne mb-10"
        >
          {event?.status === "matching" ? (
            "✨ Matching in progress..."
          ) : event?.reveal_time ? (
            "Matching begins at reveal time"
          ) : (
        ...
        {/* Countdown timer */}
        {event?.reveal_time && event.status === "waiting" && (
          <motion.div
        ...
        >
          ...
          <p className="text-foreground">
            {[
              "Take a deep breath, your match is being calculated ✨",
