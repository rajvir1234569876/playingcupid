                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                  {GENDERS.map((g) => (
                    <Button
                      ...
                      className={formData.gender === g ? "bg-primary" : "border-border/50"}
                    >
                      {g}
                    </Button>
                  ))}
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                  {ORIENTATIONS.map((o) => (
                    <Button
                      ...
                      className={formData.orientation === o ? "bg-primary" : "border-border/50"}
                    >
                      {o}
                    </Button>
                  ))}
                ...
                <div className="grid grid-cols-3 gap-2 mt-2">
                  {SHOW_ME_OPTIONS.map((o) => (
                    <Button
                      ...
                      className={formData.showMe.includes(o) ? "bg-primary" : "border-border/50"}
                    >
                      {o}
                    </Button>
                  ))}
